...
export const { setBrandFilter, setPriceFilter, setColorFilter, setDiscountRangeFilter, setGenderFilter, setTextFilter, setCategoriesFilter, clearFilter, } = FilterSlice.actions;
